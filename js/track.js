...
var campaignID = "68986827c1e279885b4a1417";
...
var initialSrc = "https://cbh.cogbrainhealth.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("cbh.cogbrainhealth.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://cbh.cogbrainhealth.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://cbh.cogbrainhealth.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
